...
mpl.rcParams['font.family'] = 'Sans-Serif' # font type
...
def temperature_anomalies(station,year_begin,year_end):
  ...
  # draw lineplot of all temperatures
  sns.lineplot(data = df[df["NAME"] == station],
               x = "Date",
               y = "Temp",
               color = "lightgrey");

  # produce scatterplot of anomalies
  sns.scatterplot(data = anomalies[anomalies["NAME"] == station],
                  x = "Date",
                  y = "Temp",
                  zorder = 100, # show the dots on top of lineplot
                  hue = "z", # color by z-score
                  s = 30, # size
                  palette = "vlag"); # color palette
...
Output
```python
temperature_anomalies(station = "DARJEELING",
                      year_begin = 1960,
                      year_end = 2020)

```
![_config.yml]({{ site.baseurl }}/images/temp-anomalies-hw1.png)
