...
## §2. Create a post!
### How to create an interesting data visualisation of the Palmer Penguins data Set
...
After running df.info(), we can view information on the Palmer Penguins data set.
```python
df.info()
```
